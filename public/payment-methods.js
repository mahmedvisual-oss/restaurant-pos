...
(function () {
  ...
  function enhancePaymentMethods() {
    ...
    box.innerHTML = [
      ...
      '<div class="payment-method-group"><button type="button" class="pay-method payment-group" onclick="togglePaymentGroup(this)">' + LABELS.credit + ' ▾</button><div class="payment-submethods">' + optionButtons([
        { value: PAYMENT_METHODS.credit_bca, label: "🏦 BCA" },
        { value: PAYMENT_METHODS.credit_mandiri, label: "💳 Mandiri" }
      ]) + '</div></div>',
      '<div class="payment-method-group"><button type="button" class="pay-method payment-group" onclick="togglePaymentGroup(this)">' + LABELS.debit + ' ▾</button><div class="payment-submethods">' + optionButtons([
        { value: PAYMENT_METHODS.debit_bca, label: "🏦 BCA" },
        { value: PAYMENT_METHODS.debit_mandiri, label: "💳 Mandiri" }
      ]) + '</div></div>',
      '<div class="payment-method-group"><button type="button" class="pay-method payment-group" onclick="togglePaymentGroup(this)">' + LABELS.wallet + ' ▾</button><div class="payment-submethods">' + optionButtons([
      ...
      '<div class="payment-method-group"><button type="button" class="pay-method payment-group" onclick="togglePaymentGroup(this)">' + LABELS.bank + ' ▾</button><div class="payment-submethods">' + optionButtons([
