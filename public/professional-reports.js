...
(function () {
  ...
  window.printProfessionalReport = function () {
    ...
    </style></head><body><img src="/logo.png" style="width:34px;height:34px;display:block;margin:0 auto 5px;object-fit:contain">${clone.outerHTML}<div style="text-align:center;margin-top:10px;font-size:9px;color:#666">تم إصدار التقرير بواسطة نظام نقاط البيع</div></body></html>`;
