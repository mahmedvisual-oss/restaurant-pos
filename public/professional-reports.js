...
(function () {
  ...
  window.printProfessionalReport = function () {
    ...
    </style></head><body>${clone.outerHTML}<div style="text-align:center;margin-top:10px;font-size:9px;color:#666">تم إصدار التقرير بواسطة نظام نقاط البيع</div></body></html>`;
